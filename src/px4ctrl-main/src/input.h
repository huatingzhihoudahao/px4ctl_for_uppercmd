...
public:
  ...
  bool is_hover_mode;
  int positon_manual_offboard_mode;
  bool enter_hover_mode;
  bool toggle_reboot;

  static constexpr double GEAR_SHIFT_VALUE = 0.75;
  static constexpr double API_MODE_THRESHOLD_VALUE = 0.75;
  static constexpr double MODE_THRESHOLD_position_lowerbound = 0.25;
  static constexpr double MODE_THRESHOLD_position_upperbound = 0.75;
...
public:
  ...
  ros::Time rcv_stamp;
  bool recv_new_msg;
  bool reached_start_pose;
  bool getmsg_want_toggle;
  Start_pose_Data_t();
