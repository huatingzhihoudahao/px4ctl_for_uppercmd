...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "gain_hkust/Kpp0", gain_hkust.Kpp0);
	read_essential_param(nh, "gain_hkust/Kpp1", gain_hkust.Kpp1);
	read_essential_param(nh, "gain_hkust/Kpp2", gain_hkust.Kpp2);

	read_essential_param(nh, "gain_hkust/Kpi0", gain_hkust.Kpi0);
	read_essential_param(nh, "gain_hkust/Kpi1", gain_hkust.Kpi1);
	read_essential_param(nh, "gain_hkust/Kpi2", gain_hkust.Kpi2);

	read_essential_param(nh, "gain_hkust/Kpd0", gain_hkust.Kpd0);
	read_essential_param(nh, "gain_hkust/Kpd1", gain_hkust.Kpd1);
	read_essential_param(nh, "gain_hkust/Kpd2", gain_hkust.Kpd2);

	read_essential_param(nh, "gain_hkust/Kvp0", gain_hkust.Kvp0);
	read_essential_param(nh, "gain_hkust/Kvp1", gain_hkust.Kvp1);
	read_essential_param(nh, "gain_hkust/Kvp2", gain_hkust.Kvp2);

	read_essential_param(nh, "gain_hkust/Kvi0", gain_hkust.Kvi0);
	read_essential_param(nh, "gain_hkust/Kvi1", gain_hkust.Kvi1);
	read_essential_param(nh, "gain_hkust/Kvi2", gain_hkust.Kvi2);

	read_essential_param(nh, "gain_hkust/Kvd0", gain_hkust.Kvd0);
	read_essential_param(nh, "gain_hkust/Kvd1", gain_hkust.Kvd1);
	read_essential_param(nh, "gain_hkust/Kvd2", gain_hkust.Kvd2);

	read_essential_param(nh, "gain_hkust/Kv0", gain_hkust.Kv0);
	read_essential_param(nh, "gain_hkust/Kv1", gain_hkust.Kv1);
	read_essential_param(nh, "gain_hkust/Kv2", gain_hkust.Kv2);

	read_essential_param(nh, "gain_hkust/Ka0", gain_hkust.Ka0);
	read_essential_param(nh, "gain_hkust/Ka1", gain_hkust.Ka1);
	read_essential_param(nh, "gain_hkust/Ka2", gain_hkust.Ka2);
	...
	read_essential_param(nh, "rc_mode/world_frame_ctrl", rc_mode.world_frame_ctrl);
