...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/cybird/下载/px4_ctrl/src/ekf_pose/ekf_pose-68a79f9da97878e35c4707b3215a7ab7e5a09311)
  set(ekf_DEVEL_PREFIX /home/cybird/下载/px4_ctrl/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/cybird/下载/px4_ctrl/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cybird/下载/px4_ctrl/src/ekf_pose/ekf_pose-68a79f9da97878e35c4707b3215a7ab7e5a09311/${idir}'.  ${_report}")
    endif()
